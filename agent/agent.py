...
4) Key File Paths:
   - default_esr_config: configs\\default_esr_config.json
   - default_find_nv_config: configs\\default_find_nv_config.json
   - default_galvo_scan_config: configs\\default_galvo_scan_config.json
   - default_optimize_config: configs\\default_optimize_config.json
   - ESR script: experiment_scripts\\ESR.py
   - find_nv script: experiment_scripts\\find_nv.py
   - galvo_scan script: experiment_scripts\\galvo_scan.py
   - optimize script: experiment_scripts\\optimize.py
     Typically run as:
       py experiment_scripts\\ESR.py --config <some_config_file>
       py experiment_scripts\\find_nv.py --config <some_config_file>
       py experiment_scripts\\galvo_scan.py --config <some_config_file>
       py experiment_scripts\\optimize.py --config <some_config_file>
...
6) Vision Option:
   ...
   - The images are plots saved after you run experiments. The file names are data\\ESR_plot.png, data\\FindNV_plot.png, data\\GalvoScan_plot.png and data\\Optimization_plot.png
...
7) Typical usage flow for ESR, can be migrated to doing any experiments by replacing 'esr' with the experiment:
   ...
   - Read the default config at configs\\default_esr_config.json.
   - Write a new config, e.g. configs\\my_new_experiment.json, changing relevant fields based on the insight from the previous experiment.
   - Run the command: 
         py experiment_scripts\\ESR.py --config configs\\my_new_experiment.json
8) Behavior:
